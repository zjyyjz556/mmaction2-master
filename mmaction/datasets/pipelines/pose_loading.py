...
#            inds = self._get_train_clips(num_frames, self.clip_len)
            inds = self._get_train_clips(num_frames, num_frames)
...
#                np.save("/home/zeng_jy/mmaction2-master/heatmap/heatmap.npy", heatmap)
    ...
    def gen_an_aug(self, results):
        ...
        for i in range(num_frame):
            ...
            imgs.append(hmap)
#            np.save("/home/zeng_jy/mmaction2-master/heatmap/imgs.npy", imgs)
#            np.save("/home/zeng_jy/mmaction2-master/heatmap/hmap.npy", hmap)

#        np.save("/home/zeng_jy/mmaction2-master/heatmap/{}imgs.npy".format(results['label']), imgs)
#        np.save("/home/zeng_jy/mmaction2-master/heatmap2/{}imgs.npy".format(results['label']), imgs)
        return imgs

    def __call__(self, results):
        if not self.double:
            results['imgs'] = np.stack(self.gen_an_aug(results))
#            np.save("/home/zeng_jy/mmaction2-master/heatmap2/{}imgs.npy".format(results['frame_dir']), results['imgs'])
#            np.save("/home/zeng_jy/mmaction2-master/heatmap3/{}results.npy".format(results['frame_dir']), results)
        else:
...
#        np.save("/home/zeng_jy/mmaction2-master/UWIOMheatmap/{}results.npy".format(results['frame_dir']), results)
        return results
