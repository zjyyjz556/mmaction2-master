...
mmdet_root = '/home/zeng_jy/anaconda3/envs/a/lib/python3.7/site-packages/mmdet/.mim'
mmpose_root = '/home/zeng_jy/anaconda3/envs/a/lib/python3.7/site-packages/mmpose/.mim'
...
def extract_frame(video_path):
    ...
    del frame_paths[1870]
    del frame_paths[1869]
    del frame_paths[1868]
    del frame_paths[1867]
    del frame_paths[1866]
    del frame_paths[1865]
    del frame_paths[0:82]
    return frame_paths
...
#        print(result[0][:, 4])
        if len(result[0]) == 3:
            result = result[0][result[0][:, 4] >= 0.8]
        if len(result[0]) == 2:
            if result[0][0][4] >= 0.6 or result[0][1][4] >= 0.6:
                result = result[0][result[0][:, 4] >= 0.8]
            elif (result[0][0][4] >= 0.3 and result[0][0][4] <= 0.6) or (result[0][1][4] >= 0.3 and result[0][0][4] >= 0.6):
                result = result[0][result[0][:, 4] >= 0.4]
        else:
            result = result[0][result[0][:, 4] >= 0.25]
        '''

#        print([result[0][:, 4] >= 0.6])
        if result[0][0][4] >= 0.9:
            result = result[0][result[0][:, 4] >= 0.9]
        elif result[0][0][4] >= 0.8:
            result = result[0][result[0][:, 4] >= 0.8]
        elif result[0][0][4] >= 0.7:
            result = result[0][result[0][:, 4] >= 0.7]
        elif result[0][0][4] >= 0.6:
            result = result[0][result[0][:, 4] >= 0.6]
        elif result[0][0][4] >= 0.53:
            result = result[0][result[0][:, 4] >= 0.53]
        elif result[0][0][4] >= 0.4:
            result = result[0][result[0][:, 4] >= 0.4]
        elif result[0][0][4] >= 0.3:
            result = result[0][result[0][:, 4] >= 0.3]
        elif result[0][0][4] >= 0.2:
            result = result[0][result[0][:, 4] >= 0.2]
        elif result[0][0][4] >= 0.1:
            result = result[0][result[0][:, 4] >= 0.10]
        else:
            result = result[0][result[0][:, 4] >= 0.05]
#            result = result[0][result[0][:, 4] >= args.det_score_thr]
#       (result[0][0][4] >= 0.1 and result[0][0][4] <= 0.6) or (result[0][1][4] >= 0.3 and result[0][0][4] >= 0.6)
...
#        det_results = [x[x[..., -1] > 0.95] for x in det_results]
        det_results = [x[x[..., -1] > threshold] for x in det_results]
#        np.save("/home/zeng_jy/mmaction2-master/tools/data/skeleton/det_results.npy", det_results)
