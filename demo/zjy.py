...
#path = r'/home/zeng_jy/mmaction2-master/tools/data/S002C001P008R002A088.pkl'
path = r'/home/zeng_jy/mmaction2-master/tools/data/skeleton/S001C001P001R001A005.pkl'
f = open(path, 'rb')
anno = pickle.load(f)
keypoint_heatmap = get_pseudo_heatmap(anno)
np.save("/home/zeng_jy/mmaction2-master/heatmap3/{}results.npy".format(anno['frame_dir']), keypoint_heatmap)
keypoint_mapvis = vis_heatmaps(keypoint_heatmap)


vid = mpy.ImageSequenceClip(keypoint_mapvis, fps=24)
vid.ipython_display(maxduration=240)

'''
#ntu_root = '/home/zeng_jy/mmaction2-master/tools/data/skeleton'
#vid_path = osp.join(ntu_root, 'S002C001P008R002A088_rgb.avi')

keypoint_heatmap = get_pseudo_heatmap(anno)
#np.save("/home/zeng_jy/mmaction2-master/{}results.npy".format(anno['frame_dir']), anno)
keypoint_mapvis = vis_heatmaps(keypoint_heatmap)
...
im.save("your_file11.jpeg")
im = Image.fromarray(keypoint_mapvis[54])
im.save("your_file111.jpeg")
#keypoint_mapvis = [add_label(f, gym_categories[25]) for f in keypoint_mapvis]
keypoint_mapvis = [add_label(f, ntu_categories[25]) for f in keypoint_mapvis]
im = Image.fromarray(keypoint_mapvis[0])
im.save("your_file2.jpeg")
im = Image.fromarray(keypoint_mapvis[30])
im.save("your_file22.jpeg")
im = Image.fromarray(keypoint_mapvis[54])
im.save("your_file222.jpeg")
...
limb_heatmap = get_pseudo_heatmap(anno, 'limb')
limb_mapvis = vis_heatmaps(limb_heatmap)
vid = mpy.ImageSequenceClip(limb_mapvis, fps=36)
vid.ipython_display()
'''
